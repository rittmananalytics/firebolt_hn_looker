- dashboard: hn_firebolt_demo
  title: HN Firebolt Demo
  layout: newspaper
  ...
  - title: Content by Month
    ...
    listen:
      ...
      Author: hacker_news_all.author
      Descendants: hacker_news_all.descendants
    row: 3
    col: 16
    width: 8
    height: 8
  ...
  - name: Type
    title: Type
    type: field_filter
    default_value: comment,story,job,poll,pollopt
  ...
  - name: Descendants
    ...
    explore: hacker_news_all
    listens_to_filters: []
    field: hacker_news_all.descendants
